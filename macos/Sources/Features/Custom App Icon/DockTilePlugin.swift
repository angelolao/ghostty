...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.angelolao.ghostty-sidebar.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.angelolao.ghostty-sidebar")
    #endif
